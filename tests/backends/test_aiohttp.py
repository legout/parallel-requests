...
@pytest.mark.asyncio
async def test_aiohttp_backend_name():
    backend = AiohttpBackend()
    assert backend.name == "aiohttp"


@pytest.mark.asyncio
async def test_aiohttp_backend_supports_http2():
    backend = AiohttpBackend()
    assert backend.supports_http2() is False


@pytest.mark.asyncio
async def test_aiohttp_backend_context_manager():
...
@pytest.mark.asyncio
async def test_aiohttp_backend_get_request():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_post_json():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_post_data():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_with_headers():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_with_params():
    async with AiohttpBackend() as backend:
        config = RequestConfig(
...
@pytest.mark.asyncio
async def test_aiohttp_backend_timeout():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_different_methods():
    async with AiohttpBackend() as backend:
...
@pytest.mark.asyncio
async def test_aiohttp_backend_error_without_context_manager():
    backend = AiohttpBackend()
    config = RequestConfig(url="https://httpbin.org/get", method="GET")
